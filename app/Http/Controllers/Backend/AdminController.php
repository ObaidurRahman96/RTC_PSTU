...
class AdminController extends Controller
{
	...
	public function index()
	{
		...
		return view('backend.pages.all_admin.index', compact('myAdmines'));
	} 


	public function create()
	{
		return view('backend.pages.all_admin.create');
	}
	...
	public function edit($id)
	{
		...
		return view('backend.pages.all_admin.edit', compact('admin'));
	}
