...
@section('fav_title', __('backend/file_manager.file_manager') )
...
<div class="app-title">
	...
	<ul class="app-breadcrumb breadcrumb">
		...
		<li class="breadcrumb-item active">{{ __('backend/file_manager.file_manager') }}</li>
	</ul>
</div>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<div class="row">
					<div class="col-md-6"><h2><i class="{{ 'fa fa-table' }}"></i> {{ __('backend/file_manager.file_manager_list') }}</h2></div>
					<div class="col-md-6"><a href="{{ route('admin.file_manager.add') }}" class="float-right btn btn-primary"><i class="fa fa-plus"></i> {{ __('backend/default.add_new') }}</a></div>
